...
# location
tk.Label(root, text="Сдвиг:").grid(row=4, column=0, sticky="w", padx=10, pady=5)
tk.Entry(root, textvariable=location_var).grid(row=4, column=1, padx=10)

# scale
tk.Label(root, text="Масштаб:").grid(row=5, column=0, sticky="w", padx=10, pady=5)
tk.Entry(root, textvariable=scale_var).grid(row=5, column=1, padx=10)

# n
tk.Label(root, text="Размер выборки:").grid(row=6, column=0, sticky="w", padx=10, pady=5)
tk.Entry(root, textvariable=n_var).grid(row=6, column=1, padx=10)

# number of resample
tk.Label(root, text="Количество ревыборок:").grid(row=7, column=0, sticky="w", padx=10, pady=5)
